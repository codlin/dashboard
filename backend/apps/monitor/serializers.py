...
from .models import Product, ProductRelease, SysMenu, Testline, CaseName, CasePath, TestcaseRelease, LoadTestcaseStatus, LoadStatus, \
    CaseSchedule, TestlineStableLoad
...
class CaseScheduleSerializer(serializers.ModelSerializer):
    class Meta:
        model = CaseSchedule
        fields = "__all__"
...
class TestlineStableLoadSerializer(serializers.ModelSerializer):
    class Meta:
        model = TestlineStableLoad
        fields = "__all__"
